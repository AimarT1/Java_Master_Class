...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //new add after innerclass configuration
        Album B_O_B = new Album("B.O.B","The adventures of Bobby Ray");
        B_O_B.addSong("Fame",03.42);
        B_O_B.addSong("Airplanes",03.01);
        B_O_B.addSong("Letters from Vietnam",04.13);
        albumArrayList.add(B_O_B);

        B_O_B.printSongsInAlbum();
        printAlbums();

        B_O_B.addSongsToPlaylist("Letters from Vietnam",playList);
        B_O_B.addSongsToPlaylist("Airplanes",playList);
        printPlayList(playList);
        playPlayList(playList);
